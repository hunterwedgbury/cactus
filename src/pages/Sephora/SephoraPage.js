    ...
    return (
        ...
        <section className='sephora'>
            ...
            <div className='sephora__header'>
                <Link to='../discover'>
                    <img className='sephora__header--arrow' src={arrow}/>  
                </Link>              
                <h1 className='sephora__header--text'>Sephora</h1>
            </div>

            <div className='sephora__body'>
                <img className='sephora__art' src={sephoraArt}/>
                ...
                <p className='sephora__subheader--text'>Make your first purchase to start collecting rewards!</p>
                ...
                <div className='sephora__redeem-container'>
                    ...
                    <div className='sephora__points-button'>
                        ...
                        <img className='sephora__points-icon' src={cactusWhite}/>
                    </div>
                </div>
