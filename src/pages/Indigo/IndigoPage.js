    ...
    return (
        ...
        <section className='indigo'>
            ...
            <div className='indigo__header'>
                <Link to='../discover'>
                    <img className='indigo__header--arrow' src={arrow}/>  
                </Link>              
                <h1 className='indigo__header--text'>Indigo</h1>
            </div>

            <div className='indigo__body'>
                <img className='indigo__art' src={indigoArt}/>
                ...
                <p className='indigo__subheader--text'>Make your first purchase to start collecting rewards!</p>
                ...
                <div className='indigo__redeem-container'>
                    ...
                    <div className='indigo__points-button'>
                        ...
                        <img className='indigo__points-icon' src={cactusWhite}/>
                    </div>
                </div>
