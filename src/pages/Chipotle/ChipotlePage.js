  ...
  return (
    <section className="chipotle">
      <div className="chipotle__header">
        <Link to="../discover">
          <img className="chipotle__header--arrow" alt="arrow" src={arrow} />
        </Link>
        <h1 className="chipotle__header--text">Indigo</h1>
      </div>

      <div className="chipotle__body">
        <img className="chipotle__art" alt="chipotle art" src={chipotleArt} />
        ...
        <p className="chipotle__subheader--text">
        ...
        <div className="chipotle__redeem-container">
          ...
          <div className="chipotle__points-button">
            ...
            <img
              className="chipotle__points-icon"
              alt="cactus logo"
              src={cactusWhite}
            />
          </div>
