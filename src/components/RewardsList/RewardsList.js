    ...
    <section className="rewards-list">
      <Link to="../discover/starbucks">
        <div className="rewards-list__container">
          <img className="rewards-list__logo" alt="starbucks" src={logo1} />
      ...
      <Link to="../discover/lululemon">
        <div className="rewards-list__container">
          <img className="rewards-list__logo" alt="lululemon" src={logo2} />
          <div className="rewards-list__text-container">
      ...
      <Link to="../discover/mcdonalds">
        <div className="rewards-list__container">
          <img className="rewards-list__logo" alt="mcdonalds" src={logo3} />
          <div className="rewards-list__text-container">
      ...
      <Link to="../discover/aritzia">
        <div className="rewards-list__container">
          <img className="rewards-list__logo" alt="aritzia" src={logo4} />
          <div className="rewards-list__text-container">
