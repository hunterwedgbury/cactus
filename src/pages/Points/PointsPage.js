    ...
    return (
        ...
        <section className='points'>
            ...
            <div className='points__header'>
                <Link to='../'>
                    <img className='points__header--arrow' src={arrow}/>  
                </Link>              
            ...
            <div className='points__points-button'>
                <div className='points__points-button-container'>
                    ...
                    <img className='points__points-icon' src={cactusGreen}/>
                </div>
                <p className='points__body'>Welcome to the loyalty rewards app for every retail transaction on the planet.</p>
            </div>
