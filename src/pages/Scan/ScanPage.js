        ...
        <section className='scan'>
            ...
            <div className='scan__header'>
                <div className='scan__points-container'>
                    ...
                    <img className='scan__points-icon' src={cactusGreen}/>
                </div>            
                <h1 className='scan__header--text'>Hunter</h1>
                <Link to='../profile'>
                    <img className='scan__profile-icon' src={profile}/>
                </Link>
            </div>
            ...
            <div className='scan__scan-container'>
                ...
                <div className='scan__text-container'>
                    ...
                    <img className='scan__points-icon--body' src={cactusGreen}/>
                    <p className='scan__text'>per $1</p>
                </div>
                <img className='scan__qrcode' src={qrcode}/>
            </div>
