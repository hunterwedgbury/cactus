    ...
    <section>
      <Link to="../discover/starbucks">
        <div className="discover-list__container">
          <img className="discover-list__logo" alt="starbucks" src={logo1} />
      ...
      <Link to="../discover/lululemon">
        <div className="discover-list__container">
          <img className="discover-list__logo" alt="lululemon" src={logo2} />
          <div className="discover-list__text-container">
      ...
      <Link to="../discover/mcdonalds">
        <div className="discover-list__container">
          <img className="discover-list__logo" alt="mcdonalds" src={logo3} />
          <div className="discover-list__text-container">
      ...
      <Link to="../discover/aritzia">
        <div className="discover-list__container">
          <img className="discover-list__logo" alt="aritzia" src={logo4} />
          <div className="discover-list__text-container">
      ...
      <Link to="../discover/chipotle">
        <div className="discover-list__container">
          <img className="discover-list__logo" alt="chipotle" src={logo7} />
          <div className="discover-list__text-container">
      ...
      <Link to="../discover/sephora">
        <div className="discover-list__container">
          <img className="discover-list__logo" alt="sephora" src={logo6} />
          <div className="discover-list__text-container">
      ...
      <Link to="../discover/indigo">
        <div className="discover-list__container">
          <img className="discover-list__logo" alt="indigo" src={logo5} />
          <div className="discover-list__text-container">
